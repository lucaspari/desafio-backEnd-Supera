...
public class TransferenciaController {
    ...
    public ResponseEntity<List<Transferencia>> listar(
        ...
        if (d1 != null && d2 != null && nome != null) {
            transferencias = transferenciaService.
            findAllTransferenciasByDataBetweenAndNomeOp(nome,d1,d2);
        } else if (d1 != null && d2 != null) {
            transferencias = transferenciaService.findAllTransferenciaByDataBetween(d1, d2);
        } else if (nome != null) {
            transferencias = transferenciaService.findAllTransferenciaByNomeOperadorResponsavel(nome);
        } else {
